        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              ...
              <h6 className="special-heading fw-300 text-center" style={{ 'margin': '0 0 20px 0' }}>Մանրամասն ծանոթացեք վեբ ուսուցման ծրագրին</h6>
              <h6 style={{ 'margin': '0 0 20px 0', textAlign: 'center' }}>Այստեղ ներկայացված են մեր վեբ ծրագրավորման վիդեոդասերը, որոնք դիտելով դուք կծանոթանաք մեր դասավանդման մեթոդիկային։</h6>
              <div className="row justify-content-center">
                <div className="col-md-10 col-xl-7">
                  <div className="filters course-filters text-lg-right">
                    <a href="" data-filter="3" className="active" onClick={this.f3}>Full Stack</a>
